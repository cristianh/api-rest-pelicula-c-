...
namespace AppPeliculas.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            ...
            {
                //Conexion
                //strCadenaCnx = "Data Source=DESKTOP-LNJACP7;Initial Catalog=DB_API_PELICULAS; Integrated Security=True";
                strCadenaCnx = "workstation id=DBAPIPELICULAS.mssql.somee.com;packet size=4096;user id=CristianH_SQLLogin_1;pwd=bsvp1khp8g;data source=DBAPIPELICULAS.mssql.somee.com;persist security info=False;initial catalog=DBAPIPELICULAS";
